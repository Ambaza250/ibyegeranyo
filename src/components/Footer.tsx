      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="text-white font-semibold">Aime Christian</div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/documentaries" className="text-text-muted text-sm hover:text-white transition-colors">
                  Documentaries
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-text-muted text-sm hover:text-white transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-text-muted text-sm hover:text-white transition-colors">
                  Pricing
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-muted text-sm">
            &copy; {currentYear} Aime Christian Documentaries. All rights reserved.
          </p>
          <p className="text-text-muted text-xs">
            Payments verified manually via MTN MoMo
          </p>
        </div>
      </div>
    </footer>
